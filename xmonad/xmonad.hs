...
myppTitle = "#FDF6E3"
myppUrgent = "#DC322F"
myWorkspaces = ["1:www", "2:dev", "3:sys", "4:doc", "5:zoom", "6:edit", "7:chat", "8:mus", "9:oth"]
...
myManageHook = composeAll
    [ className =? "Pentablet_Driver"   --> doShift "9:oth"
...
main :: IO ()
main = do
    xmproc1 <- spawnPipe "xmobar -x 1 /home/tcmb139/.config/xmobar/xmobarrc1"
